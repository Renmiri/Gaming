...
BYTE pattern3[] = {0x51, 0x80, 0x7C, 0x24, 0x10, 0x01, 0x53, 0x55, 0x56, 0x8B, 0x74, 0x24, 0x18, 0x57, 0xC7, 0x44};
...
DWORD WINAPI Start(LPVOID lpParam)
{
		...
		if(ADDRESS)
			{
				 fprintf(Log, "Patched Cert Check!\n");
				 osub_F4E470 = (FUNC_F4E4)DetourFunction((PBYTE)ADDRESS, (PBYTE)CertCheck);
			}
		else
			fprintf(Log, "Patched Cert Check failed!\n");
		fclose ( Log );
		return 0;
}
